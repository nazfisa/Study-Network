                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(action('PollAnswerController@store')); ?>"
                                ...
                                <?php $__currentLoopData = $polls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $poll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?= $option; ?> <input type="radio"
                                                                           name="answer_<?php echo e($poll->id); ?>[<?php echo e($poll->course_id); ?>]"
                                                                           value="<?= $option; ?>">
                                                    <?php }
                                                    ?>
                                                </td>
